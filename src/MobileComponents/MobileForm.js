...
class MobileForm extends Component {
    ...
    addConventionMobile(event) {
        console.log(this.titleValue.value);
        console.log(this.selectCategoryValue.value);
        console.log(this.startDateInput.value);
        console.log(this.state.address);
        console.log(this.state.values[0]);
        console.log(this.selectDescValue.value);
        // console.log(this.selectImgValue.value);
                ...
                <div className={classes.formBox}>
                    ...
                    >
                        ...
                        >
                            ...
                            <option value="radiationDamage">Radiation damage</option>
                        ...
                        <div className={classes.picUpload}>
                            <ImageUploader
                                withIcon={true}
                                buttonImage='Choose images'
                                onChange={this.onDrop}
                                imgExtension={['.jpg', '.gif', '.png', '.gif']}
                                maxFileSize={5242880}
                                ref={selectImgValue => (this.selectImgValue = selectImgValue)}
                            />
                        </div>
